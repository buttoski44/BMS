export const Moto = () => {
  return (
    <div className="px-2 sm:px-10 lg:px-40 my-96 w-full sm:h-[calc(100vh-6rem)] bg-[#00ADEF]  flex-col flex sm:flex-row justify-center items-center gap-14">
      <div className="w-1/2 h-1/2 flex flex-col justify-center gap-5">
        <h2 className="py-3 text-start text-6xl font-bold padding-10 text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-blue-100">
          Moto
        </h2>
        <div className="py-4 text-blue-100 text-start">
